...
public class enterizos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("CATALOGO").child("Enterizos");
        ...
        fabAgregarPrenda.setOnClickListener(v -> {
            ...
            String categoria = "Enterizos";

            SharedPreferences.Editor editor=preferences.edit();
            editor.putString("categoria", categoria);
            editor.commit();
            startActivity(new Intent(enterizos.this, AgregarPrendas.class));
        });
