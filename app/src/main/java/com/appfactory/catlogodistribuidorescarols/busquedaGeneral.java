...
public class busquedaGeneral extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busqueda_general);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("CATALOGO").child("Todas las prendas");
        ...
        fabAgregarPrenda.setOnClickListener(v -> {
            startActivity(new Intent(busquedaGeneral.this, AgregarPrendas.class));
        });
