...
public class conjuntosPantalon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_conjuntos_pantalon);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("CATALOGO").child("Conjuntos con Pantalon");
        ...
        fabAgregarPrenda.setOnClickListener(v -> {
            ...
            String categoria = "Conjuntos con Pantalon";

            SharedPreferences.Editor editor=preferences.edit();
            editor.putString("categoria", categoria);
            editor.commit();
            startActivity(new Intent(conjuntosPantalon.this, AgregarPrendas.class));
        });
