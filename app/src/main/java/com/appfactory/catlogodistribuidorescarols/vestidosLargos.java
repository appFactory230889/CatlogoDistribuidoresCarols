...
public class vestidosLargos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("CATALOGO").child("Vestidos Largos");
        ...
        fabAgregarPrenda.setOnClickListener(v -> {
            ...
            String categoria = "Vestidos Largos";

            SharedPreferences.Editor editor=preferences.edit();
            editor.putString("categoria", categoria);
            editor.commit();
            startActivity(new Intent(vestidosLargos.this, AgregarPrendas.class));
        });
