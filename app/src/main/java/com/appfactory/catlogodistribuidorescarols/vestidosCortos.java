...
public class vestidosCortos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vestidos_cortos);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("CATALOGO").child("Vestidos Cortos");
        ...
        fabAgregarPrenda.setOnClickListener(v -> {
            ...
            String categoria = "Vestidos Cortos";

            SharedPreferences.Editor editor=preferences.edit();
            editor.putString("categoria", categoria);
            editor.commit();
            startActivity(new Intent(vestidosCortos.this, AgregarPrendas.class));
        });
