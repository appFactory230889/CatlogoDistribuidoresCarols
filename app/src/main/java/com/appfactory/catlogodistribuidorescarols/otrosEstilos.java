...
public class otrosEstilos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otros_estilos);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("CATALOGO").child("Otros Estilos");
        ...
        fabAgregarPrenda.setOnClickListener(v -> {
            ...
            editor.commit();
            startActivity(new Intent(otrosEstilos.this, AgregarPrendas.class));
        });
